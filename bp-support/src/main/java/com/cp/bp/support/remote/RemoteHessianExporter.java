 ...
 * 功能：
 */
public class RemoteHessianExporter extends RemoteExporter implements InitializingBean {
    ...
    public void prepare() {
        ...
        this.skeleton = new RemoteHessianSkeleton(getProxyForService(), getServiceInterface());
    }
